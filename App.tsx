            ...
            <div className="sticky top-6 z-50 bg-white/90 backdrop-blur-xl border border-slate-200 rounded-[32px] p-4 shadow-2xl flex flex-col md:flex-row items-center justify-between gap-8 mb-16">
              <div className="flex items-center gap-8 pl-4">
                <div className="flex flex-col">
                  <label className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] mb-2">Desired Size</label>
                  <div className="flex items-center bg-slate-100 rounded-2xl p-1.5 pr-2 focus-within:ring-2 focus-within:ring-blue-500/20 transition-all">
                    ...
                    <div className="flex bg-white rounded-xl p-1 shadow-sm border border-slate-200/50">
                      <button 
                        onClick={() => setUnit('KB')}
                        className={`px-4 py-1 text-xs font-black rounded-lg transition-all ${unit === 'KB' ? 'bg-blue-600 text-white shadow-md' : 'text-slate-400 hover:text-slate-600'}`}
                      >
                        KB
                      </button>
                      <button 
                        onClick={() => setUnit('MB')}
                        className={`px-4 py-1 text-xs font-black rounded-lg transition-all ${unit === 'MB' ? 'bg-blue-600 text-white shadow-md' : 'text-slate-400 hover:text-slate-600'}`}
                      >
                        MB
                      </button>
                    </div>
